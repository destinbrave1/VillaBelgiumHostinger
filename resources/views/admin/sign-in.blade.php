              ...
              <div class="card-body">
                ...
                @endif
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input ttype="email" name="email" placeholder="Email" required class="form-control">
                  </div>
                  ...
                  <p class="mt-4 text-sm text-center">
                    click here if you are not an admin?
                    <a href="{{route('home')}}" class="text-primary text-gradient font-weight-bold">user</a>
                  </p>
                </form>
              </div>
            </div>
      ...
      <footer class="footer position-absolute bottom-2 py-2 w-100">
        <div class="container">
          <div class="row align-items-center justify-content-lg-between">
            ...
            <address>    
                web designer credentials (backend dev)<br> 
