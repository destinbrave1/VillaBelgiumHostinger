          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" 
                href="{{ route('register') }}">New contact</a>
            </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">New contact</h6>
              </div>
            </div>
            <div class="container">
              ...
              @endif
              <form action="{{ route('registerContact') }}" method="POST" enctype="multipart/form-data"
                onsubmit="return validatePropertyType()">
                @csrf
                @if ($errors->any())
                ...
                <div class="form-group">
                  ...
                  <input type="email" id="emai_1 "name="email_1" autofocus required><br><br>
                 
                  <label for="email_2">email 2 </label>
                  <input type="email" id="emai_2" name="email_2" autofocus ><br><br>
                   
                  <label for="phone_number1">phone 1</label>
                  <input type="phone_number1" id="phone_number1" name="phone_number1" autofocus required><br><br>
                    
                  <label for="phone_number2">phone 2</label>
                  <input type="phone_number2" id="phone_number2" name="phone_number2" autofocus ><br><br>
                    
                  <label for="phone_number3">phone 3</label>
                  <input type="phone_number3" id="phone_number3" name="phone_number3" autofocus ><br><br>
                  <label for="copyright_year">copyright year</label>
                  <input type="copyright_year" id="copyright_year" name="copyright_year" autofocus ><br><br>
