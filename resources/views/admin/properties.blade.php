        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3"  href="{{ route('register') }}">ADD PROPERTY</a>
            </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Available properties</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach ($select as $property)
                    <tr>
                      ...
                      <td><img src="{{ asset('property_images/'.$property->image ) }}" alt="" height="150" width="150"></td>
                     
                      <td class="align-middle text-center">
                      <form action="{{ route('delete-property', ['id' => $property->id]) }}" method="POST" id="deleteForm{{ $property->id }}">
                        @csrf
                        @method('DELETE')
                        <br> <button class="delete-btn" onclick="confirmDelete(event)">Delete-></button>
                    </form><br>
              
                      <button class="update-btn" onclick="openUpdateModal('{{ $property->id }}', '{{ $property->property_type }}', '{{ $property->location }}','{{ $property->price }}','{{ $property->status }}','{{ asset('property_images/'.$property->image ) }}')">Update-></button>
...
<div class="modal fade" id="updatePropertyModal" tabindex="-1" role="dialog" aria-labelledby="updatePropertyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="updatePropertyModalBody">
...
function openUpdateModal(propertyId, propertyType, location, price, status, imageUrl) {
  const modalContent = `
        <form action="/update-admin/${propertyId}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group">
                <label for="propertyType">Property Type</label>
                <input type="text" class="form-control" id="propertyType" name="property_type" value="${propertyType}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="status" name="status" required>
                    <option value="Already taken" ${status === 'Already taken' ? 'selected' : ''}
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control-file" id="image" name="property_image">
                <img src="${imageUrl}" alt="Current Image" height="150" width="150">
            </div>
    ...
    document.getElementById('updatePropertyModalBody').innerHTML = modalContent;
