        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3"  href="{{route('NewAdmin')}}">NEW ADMIN</a>
            </li>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach ($select as $admin)
                    <tr>
                      ...
                      <td><img src="{{ asset('admins_images/'.$admin->image ) }}" alt="" height="150" width="150"></td>
                     
                      <td class="align-middle text-center">
                      <button class="update-btn" onclick="openUpdateModal('{{ $admin->id }}', '{{ $admin->firstname }}', '{{ $admin->lastname }}','{{ $admin->email }}','{{ $admin->telephone }}','{{ asset('admins_images/'.$admin->image )}}')">Update-></button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
...
<div class="modal fade" id="updateAdminModal" tabindex="-1" role="dialog" aria-labelledby="updateAdminModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="updateAdminModalBody">
...
function openUpdateModal(adminId, firstname, lastname, email, telephone, imageUrl) {
    const modalContent = `
        <form action="/update-admin/${adminId}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    document.getElementById('updateAdminModalBody').innerHTML = modalContent;
