          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank"
                href="{{ route('register') }}">Add Property</a>
            </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">New property</h6>
              </div>
            </div>
            <div class="container">
              ...
              <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                  ...
                  <select id="property_type" name="property_type[]" required>
                    <optgroup label="Residentials">
                      <option value="villa">Villa</option>
                      <option value="house">House</option>
                    </optgroup>

                    <optgroup label="Vehicles">
                      <option value="touring-vehicle">Touring vehicles</option>
                      <option value="other-vehicle">Other vehicles</option>
                    </optgroup>
                ...
                <br>
                <div class="form-group">
                  <label for="location">location</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  <input id="location" type="text" name="location" required>
                </div>
                <br>
                <div class="form-group">
                  <label for="price">Daily rate</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  <input id="price" type="text" name="price" required>
                </div>
                <br>
                <label for="property_image">Upload Picture&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                <input id="property_image" type="file" name="property_image" />
