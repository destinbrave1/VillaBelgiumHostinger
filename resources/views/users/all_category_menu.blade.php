                ...
                <li class="nav-item dropdown">
                  ...
                  <li>
                      <a href="{{ route('see_all') }}" class="dropdown-item item-anchor"><span
                          class="badge bg-primary ms-2">SEE ALL CATEGORIES <br></span></a>
                    </li>    
                  <li>
    ...
    <div class="container-fluid">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <div class="navigation-buttons">
                <a href="{{route('home')}}" class="prev-button"><i class="fas fa-arrow-left"></i>Go back</a>
...
function openBookingModal(propertyId, status) {
    if (status === 'available') {
        const modalContent = `
            ...
            <br>
            <a style="text-align:right;" class="btn btn-primary" href="{{route('see_all')}}" class="item-anchor">Cancel</a> 
        `;
