  ...
  <section id="best-sellers" class="best-sellers py-5 mb-5">
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
            <h4 class="text-uppercase">AVAILABLE VILLAS </h4>
            <div class="navigation-buttons">
                <a href="{{route('see_all')}}" class="prev-button"><i class="fas fa-arrow-left"></i>Go back</a>
                <a href="{{route('houses')}}" class="next-button">Next <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>

        <div data-aos="fade-in">
            @if($filteredVilla->count() == 0)
                <div class="alert alert-danger" role="alert">
                    Sorry, all properties in this category are taken.
                </div>
            @else
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4">
                    @foreach($filteredVilla as $select)
                    <div class="col">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
              ...
              <p>for more clarifications, you can call us <br>
                  ...
                  <a href="tel:Tel+250 792 108 699" class="item-anchor">Tel+250 792 108 699<br></a>From people in europe,
...
function openBookingModal(propertyId, status) {
    if (status === 'available') {
        const modalContent = `
            ...
            <br>
            <a style="text-align:right;" class="btn btn-primary" href="{{route('villas')}}" class="item-anchor">Cancel</a> 
        `;
