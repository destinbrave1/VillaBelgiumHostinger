    ...
    <div class="container-fluid">
        <div class="row align-items-center w-100">
            <div class="col-8 col-md-3">
                <a href="{{ route('home') }}">
                    <img src="images/LOGO/logoVB.png" width="204" height="46" alt="logo">
                </a>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdownPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">QUICK SEARCH</a>
                                <ul class="dropdown-menu list-unstyled p-4" aria-labelledby="dropdownPages">
                                    <li>
                                        <a href="{{ route('see_all') }}" class="dropdown-item item-anchor">
                                            <span class="badge bg-primary ms-2">SEE ALL CATEGORIES</span>
                                        </a>
                                    </li>
                                    <li>
                                        <h6>HOUSES FOR RENT</h6>
                                        <a href="{{ route('villas') }}" class="dropdown-item item-anchor">
                                            <span class="badge bg-primary ms-2">VILLA</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('houses') }}" class="dropdown-item item-anchor">
                                            <span class="badge bg-primary ms-2">RESIDENTIAL PROPERTY</span>
                                        </a>
                                    </li>
                                    <li>
                                        <h6>RENTAL CARS</h6>
                                        <a href="{{ route('other_vehicles') }}" class="dropdown-item item-anchor">
                                            <span class="badge bg-primary ms-2">Usual</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('touring_vehicles') }}" class="dropdown-item item-anchor">
                                            <span class="badge bg-primary ms-2">Tourism</span>
                                        </a>
                                    </li>
        ...
        <div class="slideshow slide-in arrow-absolute text-white" style="height: 80vh;">
            <div class="swiper-wrapper">
                <div class="swiper-slide jarallax">
                    <img src="{{asset('images/ME/villa1.jpg')}}" class="jarallax-img" alt="slideshow">
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 pt-5">
                                    <h4 class="display-1 ls-0 mt-5 pt-5 txt-fx slide-up"></h4><br><br><br>
                ...
                <div class="swiper-slide jarallax">
                <img src="images/Home/RentalCar.png" alt="categories" class="jarallax-img img-fluid">
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 pt-5">
                                    <h4 class="display-1 ls-0 mt-5 pt-5 txt-fx slide-up">Rent a car with or without a driver</h4>
                                    <p class="caption"> you can rent a car with or without a driver.  We can also tailor-make a combination trip to Kigali-Gisenyi. Safari trips to gorillas or volcanoes, you name it</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide jarallax">
                    <img src="{{asset('images/Home/highway.jpg')}}" class="jarallax-img" alt="slideshow">
                    <div class="banner-content w-100">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 pt-5">
                                    <p class="display-1 ls-0 mt-5 pt-5 txt-fx slide-up">the possibilities are endless in Villa Belgium</p>
                                    <p class="caption"> We can also tailor-make a combination trip to Kigali-Gisenyi. Safari trips to gorillas or volcanoes,arrange a cycling holiday in Kigali or Ginsenyi, you name it ! </p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <section class="features" style="position:relative; margin-top: -100px; z-index: 2;">
    ...
    <div class="container-lg">
      <div class="bg-black p-5">
        <p>What are our services for?</p>
        <div class="row">
          <div id="about-us" class="col-md-3">
            <h4 class="element-title text-capitalize my-3">rental properties</h4>
            <p>You can rent a room or the entire ground floor as an apartment or the entire house with your own chef for days or months or years...</p>
          </div>
          <div class="col-md-3">
            <h4 class="element-title text-capitalize my-3">event </h4>
            <p>Events can also be organized, such as a baby shower or family events, parties and more within a given timeframe.
              <br>We can also arrange a cycling holiday in Kigali or Ginsenyi,etc.
            </p>
          </div>
          <div class="col-md-3">
            <h4 class="element-title text-capitalize my-3">Trips</h4>
            <p>We can also tailor-make a combination trip to Kigali-Gisenyi. Safari trips to gorillas or volcanoes, you name it.
               
            </p>
          </div>
          <div class="col-md-3">
            <h4 class="element-title text-capitalize my-3">Car rental</h4>
            <p>You can also rent a car with or without a driver, for your trip, wedding or for any personal interests.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-5 my-5">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-10">
          <span class="text-primary text-lowercase">We are here for you</span>
          <h2 class="fs-2 text-center">Exciting News Await! <br> Rent Your Ideal Property Hassle-Free</h2>
<p class="text-center">Discover the convenience of renting with us. Browse our selection of available properties, including villas, cars, and more, at your leisure. Start by choosing one.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="row g-5">
            <div class="col-md-3">
                ...
                <div class="jarallax position-relative mb-4" style="height: 480px;">
                    <img src="{{asset('images/Home/VillaCategory.jpg')}}" alt="categories" class="jarallax-img img-fluid">
            ...
            <div class="col-md-3">
                ...
                <div class="jarallax position-relative mb-3" style="height: 480px;">
                    <img src="{{asset('images/Home/residential.JPG')}}" alt="categories" class="jarallax-img img-fluid">
                    <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
            ...
            <div class="col-md-3">
                ...
                <div class="jarallax position-relative mb-3" style="height: 480px;">
                    <img src="{{asset('images/Home/safari.jpeg')}}" alt="categories" class="jarallax-img img-fluid">
                    <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
            ...
            <div class="col-md-3">
                ...
                <div class="jarallax position-relative mb-3" style="height: 480px;">
                    <img src="{{asset('images/Home/weddingCar.jpeg')}}" alt="categories" class="jarallax-img img-fluid">
                    <div class="category-content position-absolute bottom-0 p-5 text-uppercase">
...
<section id="best-sellers" class="best-sellers py-5 mb-5">
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
            <h4 class="text-uppercase">ALL AVAILABLE NOW</h4>
            <div id="bookingSuccessMessage" style="display: none;">
    
            <div class="navigation-buttons">
                <a href="{{route('villas')}}" class="next-button">Next <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
...
<!-- <section class="newsletter bg-black">
    <div class="container-fluid">
        <div class="newsletter jarallax">
            <img src="{{asset('images/ME/villa2.jpg')}}" alt="newsletter" class="jarallax-img">
            ...
            <div class="row py-5 justify-content-center">
                <div class="col-md-6">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12">
                        <form id="newsletterForm" class="d-flex flex-row gap-0">
                          @csrf CSRF Token 
                          <input type="email" name="email" id="email" placeholder="Your Email Address" class="form-control rounded-0 rounded-start" required>
                          <button type="submit" class="btn btn-primary text-uppercase rounded-0 rounded-end px-5">Sign Up</button>
                      </form>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="{{route('home')}}">
                <img src="{{asset('images/LOGO/logoVB.png')}}" alt="logo" width="150">
              </a>
            </div>
...
function openBookingModal(propertyId, status) {
    if (status === 'available') {
        const modalContent = `
            ...
            <br>
            <a style="text-align:right;" class="btn btn-primary" href="{{route('home')}}" class="item-anchor">Cancel</a> 
        `;
...
<script>
    $(document).ready(function () {
        $('#newsletterForm').submit(function (e) {
            ...
            // Send AJAX request
            $.ajax({
                url: '{{ route("subscribe") }}', // Blade syntax is supported here
                type: 'POST',
                data: formData,
                headers: {
